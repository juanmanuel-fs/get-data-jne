            ...
            <div className='flex flex-col'>
              <AccordionDeclarationCandidate description='PROFESIONAL TÉCNICO EN MECÁNICA DE PRODUCCIÓN' value='SI'>
                <div className='flex flex-col gap-2'>
                  <SimpleLabelInfoCandidate label='Instituto' info='UBICACION RURAL PREDIO LA PAVA/VALLE CHANCAY/SECTOR LA PAVA COD.PRED. 7_6209275_40253 AREA Ha. 0.5900 U.C. 40253 MOCHUMI - LAMBAYEQUE - LAMBAYEQUE' bg={true}></SimpleLabelInfoCandidate>
                  <SimpleLabelInfoCandidate label='Comentario' info='CUENTO CON UN PREDIO AGRICOLA CON ESCRITURA PUBLICA NUMERO MIL DOSCIENTOS NOVENTA Y SIETE, ACTUALMENTE EN TRAMITE POR REGISTRAR ANTE SUNARP CON UN AREA DE 3 HECTARIAS CON 648 M2' bg={true}></SimpleLabelInfoCandidate>
                </div>
            ...
            <div className='flex flex-col'>
              <AccordionDeclarationCandidate description='BACHILLER EN ADMINISTRACION' value='SI'>
                <div className='grid grid-cols-12 gap-2'>
                  <SimpleLabelInfoCandidate className='col-span-9' label='Universidad' info='UNIVERSIDAD NACIONAL DE TRUJILLO' bg={true}/>
                  <SimpleLabelInfoCandidate className='col-span-3' label='Egresado' info='SI' bg={true}/>
                  <SimpleLabelInfoCandidate className='col-span-6' label='Bachiller' info='SI' bg={true}/>
                  <SimpleLabelInfoCandidate className='col-span-6' label='Año de bachillerato' info='2007' bg={true}/>
                  <SimpleLabelInfoCandidate className='col-span-6' label='Titulo' info='SI' bg={true}/>
                  <SimpleLabelInfoCandidate className='col-span-6' label='Año de titulación' info='2008' bg={true}/>
                  <SimpleLabelInfoCandidate className='col-span-full' label='Comentario' info='ESTUDIE LA CARRERA DE DESARROLLO AMBIENTAL' bg={true}/>
                </div>
              </AccordionDeclarationCandidate>
            </div>
          </div>
          ...
          <div className='flex flex-col gap-1 w-full'>
            ...
            <div className='flex flex-col'>
              <AccordionDeclarationCandidate description='IDIOMA INGLES' value='SI'>
                <div className='flex flex-col gap-2'>
                  <SimpleLabelInfoCandidate label='Centro de estudios' info='ASOCIACIÓN CULTURAL PERUANA BRITÁNICO' bg={true}/>
                  <SimpleLabelInfoCandidate label='Comentario' info='ESTUDIE LA CARRERA DE DESARROLLO AMBIENTAL' bg={true}/>
                </div>
              </AccordionDeclarationCandidate>
            </div>
          </div>
        ...
        <GeneralModal setOpen={setOpenAcademyModal} title='POSGRADOS' count={12} open={openAcademyModal}>
          <div className='flex flex-col gap-1 w-full'>
            ...
            <div className='flex flex-col'>
              <AccordionDeclarationCandidate description='BACHILLER EN ADMINISTRACION' value='SI'>
                <div className='grid grid-cols-12 gap-2'>
                  <SimpleLabelInfoCandidate className='col-span-9' label='Centro de estudios' info='UNIVERSIDAD NACIONAL DE TRUJILLO' bg={true}/>
                  <SimpleLabelInfoCandidate className='col-span-3' label='Egresado' info='SI' bg={true}/>
                  <SimpleLabelInfoCandidate className='col-span-6' label='Grado' info='Maestro' bg={true}/>
                  <SimpleLabelInfoCandidate className='col-span-6' label='Año de graduación' info='2007' bg={true}/>
                  <SimpleLabelInfoCandidate className='col-span-full' label='Comentario' info='ESTUDIE LA CARRERA DE DESARROLLO AMBIENTAL' bg={true}/>
                </div>
              </AccordionDeclarationCandidate>
              <AccordionDeclarationCandidate description='BACHILLER EN ADMINISTRACION' value='SI'>
