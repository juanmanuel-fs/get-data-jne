            ...
            <div className='flex flex-col'>
              <AccordionDeclarationCandidate description='1. SECCION ESPECIAL DE PREDIOS RURALES' value='S/. 453.00'>
                <div className='grid grid-cols-3 gap-2'>
                  <SimpleLabelInfoCandidate className='col-span-full' label='Dirección' info='UBICACION RURAL PREDIO LA PAVA/VALLE CHANCAY/SECTOR LA PAVA COD.PRED. 7_6209275_40253 AREA Ha. 0.5900 U.C. 40253 MOCHUMI - LAMBAYEQUE - LAMBAYEQUE' bg={true}></SimpleLabelInfoCandidate>
                  <SimpleLabelInfoCandidate label='Inscrito	en SUNARP' info='Si' bg={true}></SimpleLabelInfoCandidate>
                  <SimpleLabelInfoCandidate label='Partida' info='345734561' bg={true}></SimpleLabelInfoCandidate>
                  <SimpleLabelInfoCandidate label='Valor Autovalúo' info='S/. 3 457 345.00' bg={true}></SimpleLabelInfoCandidate>
                  <SimpleLabelInfoCandidate className='col-span-full' label='Información complementaria' info='CUENTO CON UN PREDIO AGRICOLA CON ESCRITURA PUBLICA NUMERO MIL DOSCIENTOS NOVENTA Y SIETE, ACTUALMENTE EN TRAMITE POR REGISTRAR ANTE SUNARP CON UN AREA DE 3 HECTARIAS CON 648 M2' bg={true}></SimpleLabelInfoCandidate>
                </div>
            ...
            <div className='flex flex-col'>
              <AccordionDeclarationCandidate description='1. SECCION ESPECIAL DE PREDIOS RURALES' value='S/. 453.00'>
                <div className='grid grid-cols-12 gap-2'>
                  <SimpleLabelInfoCandidate className='col-span-8' label='Caracteristicas' info='REGISTRO DE PROPIEDAD VEHICULAR' bg={true}/>
                  <SimpleLabelInfoCandidate className='col-span-4' label='Marca' info='TOYOTA' bg={true}/>
                  <SimpleLabelInfoCandidate className='col-span-4' label='Modelo' info='ECLIPSE' bg={true}/>
                  <SimpleLabelInfoCandidate className='col-span-4' label='Año' info='2007' bg={true}/>
                  <SimpleLabelInfoCandidate className='col-span-4' label='Placa' info='Y65-8T0' bg={true}/>
                  <SimpleLabelInfoCandidate className='col-span-full' label='Comentario' info='TRANSPORTE PERSONAL' bg={true}/>
                </div>
              </AccordionDeclarationCandidate>
              <AccordionDeclarationCandidate description='1. SECCION ESPECIAL DE PREDIOS RURALES' value='S/. 453.00'>
                <div className='grid grid-cols-12 gap-2'>
        ...
        <GeneralModal setOpen={setOpenDeclarationtModal} title='TITULADIDADES' count={4} primary='Persona Jurídica' secondary='Tipo' open={openDeclarationModal}>
          <div className='flex flex-col'>
            <AccordionDeclarationCandidate description='ESCUELA DE NEGOCIOS SAN FRANCISCO XAVIER S.A.C.' value='ACCIONES'>
              <div className='grid grid-cols-12 gap-2'>
                <SimpleLabelInfoCandidate className='col-span-6' label='Número de Acciones y Participaciones' info='889881.29' bg={true}/>
                <SimpleLabelInfoCandidate className='col-span-6' label='Valor Nominal del Total de Acciones y participaciones' info='889881.29' bg={true}/>
                <SimpleLabelInfoCandidate className='col-span-full' label='Información Complementaria' info='EL CAPITAL SOCIAL ESTA DIVIDIDO EN 1000 PARTICIPACIONES CON VALOR NOMINAL DE 1 SOL, MIS PARTICIPACIONES SON 650.' bg={true}/>
              </div>
            </AccordionDeclarationCandidate>
            <AccordionDeclarationCandidate description='ESCUELA DE NEGOCIOS SAN FRANCISCO XAVIER S.A.C.' value='ACCIONES'>
              <div className='grid grid-cols-12 gap-2'>
